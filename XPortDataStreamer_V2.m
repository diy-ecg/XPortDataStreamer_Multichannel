...
dataStream(1) = dataStreamClass("EKG","red",800,1,1); # externe Klasse
# createIIRFilter(f_abtast,f_HP,f_NO,f_TP)
dataStream(1).createIIRFilter(200,2,50,40);

# obj = dataStreamClass(name,plcolor,dt,plotwidth,plot,filter)
dataStream(2) = dataStreamClass("CH0","magenta",800,1,1); # externe Klasse
# createIIRFilter(f_abtast,f_HP,f_NO,f_TP)
dataStream(2).createIIRFilter(200,2,50,40);

# obj = dataStreamClass(name,plcolor,dt,plotwidth,plot,filter)
dataStream(3) = dataStreamClass("CH1","cyan",800,1,1); # externe Klasse
# createIIRFilter(f_abtast,f_HP,f_NO,f_TP)
dataStream(3).createIIRFilter(200,2,50,40);

### obj = dataStreamClass(name,plcolor,dt,plotwidth,plot,filter)
##dataStream(4) = dataStreamClass("CH2","green",800,1,1); # externe Klasse
### createIIRFilter(f_abtast,f_HP,f_NO,f_TP)
##dataStream(4).createIIRFilter(200,2,50,40);
##
### obj = dataStreamClass(name,plcolor,dt,plotwidth,plot,filter)
##dataStream(5) = dataStreamClass("CH3","blue",800,1,1); # externe Klasse
### createIIRFilter(f_abtast,f_HP,f_NO,f_TP)
##dataStream(5).createIIRFilter(200,2,50,40);
